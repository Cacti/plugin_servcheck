 ...
 * Test bootstrap.
 *
 * servcheck's sources expect to be included by Cacti, which has already
 ...
 * servcheck's source files build include paths from it at runtime.
 */
...
if (!function_exists('servcheck_test_read_source')) {
	function servcheck_test_read_source($relative_file) {
 ...
 * @return void
 */
function servcheck_test_load($path) {
	global $config;
